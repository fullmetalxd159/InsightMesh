 ...
 * This file demonstrates how to integrate Insightmesh with a web frontend
 */

// For React/Vue/Angular applications
export class InsightmeshClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new InsightmeshClient(provider, contractAddress);
